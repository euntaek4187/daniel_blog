...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", '').split() if os.environ.get("DJANGO_ALLOWED_HOSTS") else ['danielblogbla.netlify.app', 'daniel4191.com', "localhost", "127.0.0.1"]
